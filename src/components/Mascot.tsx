...
export const Mascot: React.FC<MascotProps> = ({
  ...
  return (
    <div className="mascot-container">
      ...
      {/* Animated Duolingo-style Mascot SVG (Muvy the Learning Owl) */}
      <div className={`mascot-svg-wrapper ${sizeClasses} ${mood}`}>
        <svg viewBox="0 0 120 120" className="w-full h-full drop-shadow-md">
          ...
          {mood === 'excited' ? (
            <>
              <ellipse cx="14" cy="55" rx="8" ry="18" fill="#46a302" transform="rotate(-30 14 55)" />
              <ellipse cx="106" cy="55" rx="8" ry="18" fill="#46a302" transform="rotate(30 106 55)" />
            </>
          ) : (
            <>
